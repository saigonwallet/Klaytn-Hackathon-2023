...
const tabs = [
  { name: 'Bonsai Collection', href: '#', current: true },
]
          ...
          <div className="flex-1 flex items-stretch overflow-hidden">
            <main className="flex-1 overflow-y-auto">
              <div className="pt-8 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex">
                  <h1 className="flex-1 text-2xl font-bold text-gray-900">My Collections</h1>
                </div>
                  ...
                  >
                    {(nfts.data as Nft[]).map((nft) => (
                      <li
                        ...
                        <div
                          className={classNames(
                            nft.bonsaiId === activeNft?.bonsaiId 
                        ...
                        >
                          <img
                            ...
                            alt=""
                            className={classNames(
                              nft.bonsaiId === activeNft?.bonsaiId  ? '' : 'group-hover:opacity-75',
