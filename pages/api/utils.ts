...
import contract from "../../public/contracts/SaigonWallet.json";
import { SaigonWalletContract } from "@_types/SaigonWalletContract";
...
process.env.BLOCKPI_BAOBAB_URL : 
"http://127.0.0.1:7545";
...
export const addressCheckMiddleware = async (req: NextApiRequest & { session: Session}, res: NextApiResponse) => {
  return new Promise(async (resolve, reject) => {
    ...
    const contract = new ethers.Contract(
      ...
      abi,
      provider
    ) as unknown as SaigonWalletContract;
