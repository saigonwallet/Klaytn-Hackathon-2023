...
const RWAssetCreate: NextPage = () => {
  ...
  const [nftMeta, setNftMeta] = useState<NftMeta>({
    ...
    attributes: [
      ...
      { trait_type: "Origin", value: "Vietnam" },
      { trait_type: "Artisan", value: "Saigon Artisan" },
    ]
  });
    ...
    <BaseLayout>
      <div>
        <div className="py-4">
          {!nftURI &&
            <div className="flex">
              <div className="mr-2 font-bold underline">Did you create bonsai metadata?</div>
              <Switch
                checked={hasURI}
        ...
        {(nftURI || hasURI) ?
          <div className="md:grid md:grid-cols-3 md:gap-6">
            <div className="md:col-span-1">
              <div className="px-4 sm:px-0">
                <h3 className="text-lg font-medium leading-6 text-gray-900">Mint for listing or certificating?</h3>
                <p className="mt-1 text-sm text-gray-600">
                  Mint Asset for listing on marketplace or getting certification.
                </p>
              </div>
            </div>
          ...
          <div className="md:grid md:grid-cols-3 md:gap-6">
            <div className="md:col-span-1">
              <div className="px-4 sm:px-0">
                <h3 className="text-lg font-medium leading-6 text-gray-900">Create Bonsai Information.</h3>
                <p className="mt-1 text-sm text-gray-600">
                  All information of Bonsai will be displayed here.
                </p>
              </div>
            </div>
            <div className="mt-5 md:mt-0 md:col-span-2">
                    ...
                    <div>
                      ...
                      <div className="mt-1 flex rounded-md shadow-sm">
                        <input
                          ...
                          id="name"
                          className="focus:ring-indigo-500 focus:border-indigo-500 flex-1 block w-full rounded-none rounded-r-md sm:text-sm border-gray-300"
                          placeholder="The full name of bonsai."
                        />
                      </div>
                    </div>
                    <div>
                      ...
                      <div className="mt-1">
                        <textarea
                          ...
                          placeholder="The most detailed information about bonsai."
                        />
                      </div>
